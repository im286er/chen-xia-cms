						...
						<tr> 
							<td width="200" id="frmtitle" valign="top">
								<dl class="sort" id='fontstyle'>
									...
									<dd><a href="<?php echo $this->createUrl('admin/myinfo'); ?>" >基本信息</a><a href="<?php echo $this->createUrl('admin/editiface');?>">上传头像</a><!-- <a href="#">我的简历</a><a href="#">作品展览</a> --><a href="<?php echo $this->createUrl('admin/photo'); ?>">相册管理</a><a href="<?php echo $this->createUrl('admin/imusic'); ?>">我的音乐</a> <a href="<?php echo $this->createUrl('admin/imv'); ?>">视频列表</a></dd>
								</dl>
