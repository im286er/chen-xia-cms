...
<div class="title"><h2>发布文章</h2></div>
<div class="maincon">
<?php $form = $this->beginWidget('CActiveForm',array(
	...
	<table class="formtable" width="100%">
		...
		<tr>
			...
			<td>
				<?php echo $form->radioButtonList($blogModel,'type',array('2'=>'普通','3'=>'视频:'),array('separator'=>'&nbsp;&nbsp'),array('')); ?>
		...
		<tr>
			<td align="right" valign="top">设置首页隐藏：</td>
			<td>
				<?php echo $form->radioButtonList($blogModel,'hide',array(0=>'显示',1=>'隐藏'), array('separator'=>'&nbsp;&nbsp')); ?>
				<?php echo $form->error($blogModel,'hide',array('id'=>'errorfield')); ?>

			</td>
		</tr>
		<tr style="display:none;">
		<td align="right" valign="top">设置文章日期：</td>
		<td>
			首发：<?php echo $form->textField($blogModel,'time',array('readonly'=>'true','style'=>'display:none'));?>
		    更新：<?php echo $form->textField($blogModel,'updatetime',array('readonly'=>'true','style'=>'display:none'));?>
		</td>
		</tr>
		<tr>
		...
		<tr>
			...
			<tr>
				<td colspan=2 align=center style='border:0;color:red;'></td>
			</tr>
			<tr>
				<td style="border:0;"></td>
				<td style="border:0;"><input type="submit" name="" value="提交发布" id="" class="btn-img" /></td>
			</tr>
		</table>
