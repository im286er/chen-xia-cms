...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000 uploader" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="" height="" id="update" align="middle">
<param name="allowFullScreen" value="false" />
    <param name="allowScriptAccess" value="always" />
	<param name="movie" value="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/CFUpload/update.swf" />
    <param name="quality" value="high" />
    <param name="bgcolor" value="#ffffff" />
    <embed src="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/CFUpload/update.swf" quality="high" bgcolor="#ffffff" width="" height="" name="update" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
</object>
</div>
</div>
</td>