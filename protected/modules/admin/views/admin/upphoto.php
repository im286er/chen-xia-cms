<td valign="top">
<div class="title"><h2>上传照片</h2></div>
<div class="maincon">
<div id="content">
 <!--影片中使用的 URL-->
  <!--影片中使用的文本-->
...
function challs_flash_update(){ //Flash 初始化函数
	...
	a.url = "<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/CFUpload/update.php"; 
	//设置服务器接收代码文件

	//传递sessionid
	a.parameter = "sessionid=<?php echo Yii::app()->session->sessionID; ?>"; 
...
<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=10,0,0,0" width="1000" height="430" id="update" align="middle">
<param name="allowFullScreen" value="false" />
    <param name="allowScriptAccess" value="always" />
	<param name="movie" value="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/CFUpload/update.swf" />
    <param name="quality" value="high" />
    <param name="bgcolor" value="#ffffff" />
    <embed src="<?php echo Yii::app()->request->baseUrl; ?>/assets/admin/CFUpload/update.swf" quality="high" bgcolor="#ffffff" width="1000" height="430" name="update" align="middle" allowScriptAccess="always" allowFullScreen="false" type="application/x-shockwave-flash" pluginspage="http://www.macromedia.com/go/getflashplayer" />
</object>
</div>
</div>
</td>